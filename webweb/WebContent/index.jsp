			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							<img class="log" src="img/log.gif" alt="log">
							<font color="white">무빙홈</font>
						</a>
					</div>
					<!-- /Logo -->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<font color=white>I'M</font><br>
							<font color=white size="49px">Song Moo-bin</font><br>
							<a class="white-btn" href="view/joinForm.jsp" role="button">회원가입</a>
							<a class="main-btn" href="qList.do?page=1" role="button">게시판</a>
						</div>
					</div>
					<!-- /home content -->
			...
			<div class="row">
				...
				<div class="col-md-7 col-sm-10">
					<div class="produce">
						...
						<p>언어 java, c, c++, python<p>
						<p>운영체제 linux, kali, cenTos<p>
						<p>웹 javascrip, jsp, css, html, jquery, spring<p>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="contact">
						...
						<h3>Address</h3>
						<p>경기도 의정부시 신곡동 능곡로 26번길 40<p><br>
